...
namespace Corvus.CosmosClient.Extensions.Specs.Common.Driver
{
    using System;
    ...
    internal static class ValueUtilities
    {
        ...
        {
            return nullableDateTimeOffsetString == "null" ? null : DateTimeOffset.Parse(nullableDateTimeOffsetString);
        }
    }
}