...
#line hidden
        ...
        public virtual void SerializeAPOCOToADocumentWith_EtagAndDeserializeToAnEntityInstance(string id, string name, string dateOfBirth, string eTag, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Serialize a POCO to a document with _etag and deserialize to an EntityInstance", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
...
#line hidden
        ...
        public virtual void Round_TripSerializeAnEntityInstance(string id, string name, string dateOfBirth, string eTag, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("DateOfBirth", dateOfBirth);
            argumentsOfScenario.Add("ETag", eTag);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Round-trip serialize an EntityInstance", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 17
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
...
#line hidden
        ...
        public virtual void CompareEntityInstancesForEquality(string leftId, string leftName, string leftDateOfBirth, string leftETag, string rightId, string rightName, string rightDateOfBirth, string rightETag, string equal, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Compare EntityInstances for equality", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 29
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
