// <copyright file="FoldToListGraphTraversal.cs" company="Endjin Limited">
...
namespace Corvus.Extensions.CosmosDb.GremlinQuery.Internal
{
    ...
    internal class FoldToListGraphTraversal<TStart, TEnd> : GraphTraversal<TStart, TEnd>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FoldToListGraphTraversal{TStart, TEnd}"/> class.
        /// </summary>
        ...
        public FoldToListGraphTraversal(ICosmosDbGremlinClient client, ITraversal parent)
            : base(client, parent)
        {
        }
