// <copyright file="InGraphTraversal.cs" company="Endjin Limited">
...
namespace Corvus.Extensions.CosmosDb.GremlinQuery.Internal
{
    ...
    internal class InGraphTraversal<TStart, TEnd> : InGraphTraversal<TStart, TEnd, Vertex>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InGraphTraversal{TStart, TEnd}" /> class.
        /// </summary>
