// <copyright file="InGraphTraversal{TStart,TEnd,TVertex}.cs" company="Endjin Limited">
...
namespace Corvus.Extensions.CosmosDb.GremlinQuery.Internal
{
    ...
    internal class InGraphTraversal<TStart, TEnd, TVertex> : GraphTraversal<TStart, TVertex>
    {
        private readonly string[] edgeLabels;

        /// <summary>
        /// Initializes a new instance of the <see cref="InGraphTraversal{TStart, TEnd, TVertex}" /> class.
        /// </summary>
        ...
        public InGraphTraversal(ICosmosDbGremlinClient client, ITraversal parent, string[] edgeLabels)
            : base(client, parent)
        {
        ...
        public override async Task WriteAsync(ITraversalWriter writer, Dictionary<string, object> bindings)
        {
            ...
            await writer.WriteAsync("in(").ConfigureAwait(false);
