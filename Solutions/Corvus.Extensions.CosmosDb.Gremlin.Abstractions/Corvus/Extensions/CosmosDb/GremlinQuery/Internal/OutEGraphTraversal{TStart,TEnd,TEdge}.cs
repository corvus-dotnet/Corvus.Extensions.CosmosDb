// <copyright file="OutEGraphTraversal{TStart,TEnd,TEdge}.cs" company="Endjin Limited">
...
namespace Corvus.Extensions.CosmosDb.GremlinQuery.Internal
{
    ...
    internal class OutEGraphTraversal<TStart, TEnd, TEdge> : GraphTraversal<TStart, TEdge>
    {
        private readonly string[] edgeLabels;

        /// <summary>
        /// Initializes a new instance of the <see cref="OutEGraphTraversal{TStart, TEnd, TEdge}" /> class.
        /// </summary>
        ...
        public override async Task WriteAsync(ITraversalWriter writer, Dictionary<string, object> bindings)
        {
            ...
            await writer.WriteAsync("outE(").ConfigureAwait(false);
