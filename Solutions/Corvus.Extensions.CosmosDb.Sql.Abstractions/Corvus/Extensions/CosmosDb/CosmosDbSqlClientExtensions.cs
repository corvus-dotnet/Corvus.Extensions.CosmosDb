// <copyright file="CosmosDbSqlClientExtensions.cs" company="Endjin Limited">
...
namespace Corvus.Extensions.CosmosDb
{
    ...
    /// <summary>
    /// Extensions for the <see cref="ICosmosDbSqlClient"/> and related types.
    /// </summary>
    public static class CosmosDbSqlClientExtensions
    {
        /// <summary>
        ...
        /// <param name="that">The client.</param>
        ...
        public static Task<ResourceResponse<Document>> InsertAsync<T>(this ICosmosDbSqlClient that, T item, RequestOptions requestOptions = null)
        {
        ...
        /// <param name="requestOptions">Cosmos DB request options.</param>
        /// <returns>The resource response of the created document.</returns>
        public static Task<ResourceResponse<Document>> UpdateAsync<T>(this ICosmosDbSqlClient that, T item, string etag, RequestOptions requestOptions = null)
        {
        ...
        public static Task<ResourceResponse<Document>> UpdateAsync<T>(this ICosmosDbSqlClient that, EntityInstance<T> entityInstance, RequestOptions requestOptions = null)
        {
            return that.UpdateAsync(entityInstance.Entity, entityInstance.ETag, requestOptions);
        }

        /// <summary>
        /// Get an entity from the client by ID.
        /// </summary>
        ...
        public static async Task<T> GetAsync<T>(this ICosmosDbSqlClient that, string id, RequestOptions requestOptions = null)
        {
        ...
        public static Task DeleteAsync(this ICosmosDbSqlClient that, string id, string partitionKey, RequestOptions requestOptions = null)
        {
        ...
        /// <param name="requestOptions">The Cosmos DB request options.</param>
        /// <returns>An instance of the specified type, or null if no entity is found.</returns>
        public static async Task<T> GetAsync<T>(this ICosmosDbSqlClient that, string id, string partitionKey, RequestOptions requestOptions = null)
        {
        ...
        public static async Task<Document> GetAsync(this ICosmosDbSqlClient that, string id, RequestOptions requestOptions = null)
        {
        ...
        /// <param name="requestOptions">The Cosmos DB request options.</param>
        /// <returns>An instance of the Cosmos DB <see cref="Document"/> type, or null if no entity is found.</returns>
        public static async Task<Document> GetAsync(this ICosmosDbSqlClient that, string id, string partitionKey, RequestOptions requestOptions = null)
        {
        ...
        public static async Task<EntityInstance<T>> GetEntityInstanceAsync<T>(this ICosmosDbSqlClient that, string id, RequestOptions requestOptions = null)
        {
            DocumentResponse<Document> response = await that.ReadDocumentAsync<Document>(id, requestOptions).ConfigureAwait(false);
        ...
        /// <param name="requestOptions">The Cosmos DB request options.</param>
        /// <returns>An instance of the specified type, annotated with version metadata.</returns>
        public static async Task<EntityInstance<T>> GetEntityInstanceAsync<T>(this ICosmosDbSqlClient that, string id, string partitionKey, RequestOptions requestOptions = null)
        {
            DocumentResponse<Document> response = await that.ReadDocumentAsync<Document>(id, requestOptions.WithPartitionKeyIfRequired(partitionKey)).ConfigureAwait(false);
            return response.Document.AsEntityInstance<T>();
        }
        ...
        /// <summary>
        /// Enumerate the documents in the client and carry out an action on each.
        /// </summary>
        ...
        public static Task ForEachAsync<T>(this ICosmosDbSqlClient that, string queryText, Action<T> action, FeedOptions feedOptions = null, CancellationToken cancellationToken = default)
        {
            if (queryText == null)
            {
        ...
        /// <param name="cancellationToken">A cancellation token to terminate the enumeration.</param>
        /// <returns>A task which completes when the iteration is complete.</returns>
        public static Task ForEachAsync<T>(this ICosmosDbSqlClient that, string queryText, SqlParameterCollection parameters, Action<T> action, FeedOptions feedOptions = null, CancellationToken cancellationToken = default)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="cancellationToken">A cancellation token to terminate the enumeration.</param>
        /// <returns>A task which completes when the iteration is complete.</returns>
        public static Task ForEachAsync<T>(this ICosmosDbSqlClient that, string queryText, Func<T, Task> task, FeedOptions feedOptions = null, CancellationToken cancellationToken = default)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="cancellationToken">A cancellation token to terminate the enumeration.</param>
        /// <returns>A task which completes when the iteration is complete.</returns>
        public static Task ForEachAsync<T>(this ICosmosDbSqlClient that, string queryText, SqlParameterCollection parameters, Func<T, Task> task, FeedOptions feedOptions = null, CancellationToken cancellationToken = default)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="cancellationToken">A cancellation token to terminate the enumeration.</param>
        /// <returns>A task which completes when the iteration is complete.</returns>
        public static Task ForEachAsync<T>(this ICosmosDbSqlClient that, string queryText, string partitionKey, Action<T> action, FeedOptions feedOptions = null, CancellationToken cancellationToken = default)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="cancellationToken">A cancellation token to terminate the enumeration.</param>
        /// <returns>A task which completes when the iteration is complete.</returns>
        public static Task ForEachAsync<T>(this ICosmosDbSqlClient that, string queryText, SqlParameterCollection parameters, string partitionKey, Action<T> action, FeedOptions feedOptions = null, CancellationToken cancellationToken = default)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="cancellationToken">A cancellation token to terminate the enumeration.</param>
        /// <returns>A task which completes when the iteration is complete.</returns>
        public static Task ForEachAsync<T>(this ICosmosDbSqlClient that, string queryText, string partitionKey, Func<T, Task> task, FeedOptions feedOptions = null, CancellationToken cancellationToken = default)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="cancellationToken">A cancellation token to terminate the enumeration.</param>
        /// <returns>A task which completes when the iteration is complete.</returns>
        public static Task ForEachAsync<T>(this ICosmosDbSqlClient that, string queryText, SqlParameterCollection parameters, string partitionKey, Func<T, Task> task, FeedOptions feedOptions = null, CancellationToken cancellationToken = default)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        public static Task<IEnumerable<TResult>> ForEachAsync<T, TResult>(this ICosmosDbSqlClient that, SqlQuerySpec sqlQuerySpec, string partitionKey, Func<T, Task<TResult>> func, FeedOptions feedOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">A cancellation token.</param>
        /// <returns>The task for the async operation.</returns>
        public static Task<IEnumerable<TResult>> ForEachAsync<T, TResult>(this ICosmosDbSqlClient that, SqlQuerySpec sqlQuerySpec, string partitionKey, Func<T, TResult> func, FeedOptions feedOptions = null, CancellationToken cancellationToken = default)
        {
            return that.ForEachAsync(sqlQuerySpec, func, feedOptions.WithPartitionKeyIfRequired(partitionKey), cancellationToken);
        }
        ...
        /// <param name="cancellationToken">A cancellation token.</param>
        /// <returns>The task for the async operation.</returns>
        public static Task ForEachAsync<T>(this ICosmosDbSqlClient that, SqlQuerySpec sqlQuerySpec, string partitionKey, Action<T> action, FeedOptions feedOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">A cancellation token.</param>
        /// <returns>The task for the async operation.</returns>
        public static Task ForEachAsync<T>(this ICosmosDbSqlClient that, SqlQuerySpec sqlQuerySpec, string partitionKey, Func<T, Task> func, FeedOptions feedOptions = null, CancellationToken cancellationToken = default)
        {
            return that.ForEachAsync(sqlQuerySpec, func, feedOptions.WithPartitionKeyIfRequired(partitionKey), cancellationToken);
        }
        ...
        public static Task<DocumentResponse<T>> ReadDocumentAsync<T>(this ICosmosDbSqlClient that, string id, string partitionKey, RequestOptions requestOptions = null)
        {
        ...
        /// <param name="that">The Cosmos DB client.</param>
        ...
        public static Task<FeedResponse<T>> ExecuteQueryAsync<T>(this ICosmosDbSqlClient that, string queryText, int pageSize, int pageIndex)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="pageIndex">The page index to retrieve.</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<T>> ExecuteQueryAsync<T>(this ICosmosDbSqlClient that, string queryText, SqlParameterCollection parameters, int pageSize, int pageIndex)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<T>> ExecuteQueryAsync<T>(this ICosmosDbSqlClient that, string queryText, int pagesToSkip = 0, FeedOptions feedOptions = null)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="feedOptions">The Cosmos DB feed options.</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<T>> ExecuteQueryAsync<T>(this ICosmosDbSqlClient that, string queryText, SqlParameterCollection parameters, int pagesToSkip = 0, FeedOptions feedOptions = null)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="pageIndex">The page index to retrieve.</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<T>> ExecuteQueryAsync<T>(this ICosmosDbSqlClient that, SqlQuerySpec sqlQuerySpec, int pageSize, int pageIndex)
        {
        ...
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<T>> ExecuteQueryAsync<T>(this ICosmosDbSqlClient that, string queryText, SqlParameterCollection parameters, int maxItemCount, string continuationToken)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="continuationToken">The previous request's continuation token (or null).</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<T>> ExecuteQueryAsync<T>(this ICosmosDbSqlClient that, string queryText, int maxItemCount, string continuationToken)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="continuationToken">The previous request's continuation token (or null).</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<T>> ExecuteQueryAsync<T>(this ICosmosDbSqlClient that, SqlQuerySpec sqlQuerySpec, int maxItemCount, string continuationToken)
        {
        ...
        public static Task<FeedResponse<T>> ExecuteQueryAsync<T>(this ICosmosDbSqlClient that, SqlQuerySpec sqlQuerySpec, FeedOptions feedOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="pageIndex">The page index to retrieve.</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<Document>> ExecuteQueryAsync(this ICosmosDbSqlClient that, string queryText, int pageSize, int pageIndex)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="pageIndex">The page index to retrieve.</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<Document>> ExecuteQueryAsync(this ICosmosDbSqlClient that, string queryText, SqlParameterCollection parameters, int pageSize, int pageIndex)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="feedOptions">The Cosmos DB feed options.</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<Document>> ExecuteQueryAsync(this ICosmosDbSqlClient that, string queryText, int pagesToSkip = 0, FeedOptions feedOptions = null)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="feedOptions">The Cosmos DB feed options.</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<Document>> ExecuteQueryAsync(this ICosmosDbSqlClient that, string queryText, SqlParameterCollection parameters, int pagesToSkip = 0, FeedOptions feedOptions = null)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="pageIndex">The page index to retrieve.</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<Document>> ExecuteQueryAsync(this ICosmosDbSqlClient that, SqlQuerySpec sqlQuerySpec, int pageSize, int pageIndex)
        {
        ...
        /// <param name="continuationToken">The previous request's continuation token (or null).</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<Document>> ExecuteQueryAsync(this ICosmosDbSqlClient that, string queryText, SqlParameterCollection parameters, int maxItemCount, string continuationToken)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="continuationToken">The previous request's continuation token (or null).</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<Document>> ExecuteQueryAsync(this ICosmosDbSqlClient that, string queryText, int maxItemCount, string continuationToken)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="continuationToken">The previous request's continuation token (or null).</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<Document>> ExecuteQueryAsync(this ICosmosDbSqlClient that, SqlQuerySpec sqlQuerySpec, int maxItemCount, string continuationToken)
        {
        ...
        public static Task<FeedResponse<Document>> ExecuteQueryAsync(this ICosmosDbSqlClient that, SqlQuerySpec sqlQuerySpec, FeedOptions feedOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <typeparam name="T">The type of the entity to retrieve.</typeparam>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<IEnumerable<EntityInstance<T>>> ExecuteQueryForEntityInstancesAsync<T>(this ICosmosDbSqlClient that, string queryText, int pageSize, int pageIndex)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <typeparam name="T">The type of the entity to retrieve.</typeparam>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<IEnumerable<EntityInstance<T>>> ExecuteQueryForEntityInstancesAsync<T>(this ICosmosDbSqlClient that, string queryText, SqlParameterCollection parameters, int pageSize, int pageIndex)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <typeparam name="T">The type of the entity to retrieve.</typeparam>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<IEnumerable<EntityInstance<T>>> ExecuteQueryForEntityInstancesAsync<T>(this ICosmosDbSqlClient that, string queryText, int pagesToSkip = 0, FeedOptions feedOptions = null)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <typeparam name="T">The type of the entity to retrieve.</typeparam>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<IEnumerable<EntityInstance<T>>> ExecuteQueryForEntityInstancesAsync<T>(this ICosmosDbSqlClient that, string queryText, SqlParameterCollection parameters, int pagesToSkip = 0, FeedOptions feedOptions = null)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <typeparam name="T">The type of the entity to retrieve.</typeparam>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<IEnumerable<EntityInstance<T>>> ExecuteQueryForEntityInstancesAsync<T>(this ICosmosDbSqlClient that, SqlQuerySpec sqlQuerySpec, int pageSize, int pageIndex)
        {
        ...
        /// <typeparam name="T">The type of the entity to retrieve.</typeparam>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<IEnumerable<EntityInstance<T>>> ExecuteQueryForEntityInstancesAsync<T>(this ICosmosDbSqlClient that, string queryText, SqlParameterCollection parameters, int maxItemCount, string continuationToken)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <typeparam name="T">The type of the entity to retrieve.</typeparam>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<IEnumerable<EntityInstance<T>>> ExecuteQueryForEntityInstancesAsync<T>(this ICosmosDbSqlClient that, string queryText, int maxItemCount, string continuationToken)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <typeparam name="T">The type of the entity to retrieve.</typeparam>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<IEnumerable<EntityInstance<T>>> ExecuteQueryForEntityInstancesAsync<T>(this ICosmosDbSqlClient that, SqlQuerySpec sqlQuerySpec, int maxItemCount, string continuationToken)
        {
        ...
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        /// <remarks>The result is a Cosmos DB <see cref="FeedResponse{T}"/> which can provide more details about the query response.</remarks>
        public static Task<IEnumerable<EntityInstance<T>>> ExecuteQueryForEntityInstancesAsync<T>(this ICosmosDbSqlClient that, SqlQuerySpec sqlQuerySpec, FeedOptions feedOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <returns>A <see cref="Task"/> which completes with a queryable over the document client.</returns>
        public static Task<IOrderedQueryable<T>> CreateDocumentQueryAsync<T>(this ICosmosDbSqlClient that, string partitionKey, FeedOptions feedOptions = null)
        {
        ...
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        /// <remarks>The result is a Cosmos DB <see cref="FeedResponse{T}"/> which can provide more details about the query response.</remarks>
        public static Task<FeedResponse<T>> ExecuteQueryAsync<T>(this ICosmosDbSqlClient that, SqlQuerySpec sqlQuerySpec, string partitionKey, int pagesToSkip = 0, FeedOptions feedOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="pageIndex">The page index to retrieve.</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<T>> ExecuteQueryAsync<T>(this ICosmosDbSqlClient that, string queryText, string partitionKey, int pageSize, int pageIndex)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="pageIndex">The page index to retrieve.</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<T>> ExecuteQueryAsync<T>(this ICosmosDbSqlClient that, string queryText, SqlParameterCollection parameters, string partitionKey, int pageSize, int pageIndex)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="feedOptions">The Cosmos DB feed options.</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<T>> ExecuteQueryAsync<T>(this ICosmosDbSqlClient that, string queryText, string partitionKey, int pagesToSkip = 0, FeedOptions feedOptions = null)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="feedOptions">The Cosmos DB feed options.</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<T>> ExecuteQueryAsync<T>(this ICosmosDbSqlClient that, string queryText, SqlParameterCollection parameters, string partitionKey, int pagesToSkip = 0, FeedOptions feedOptions = null)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="pageIndex">The page index to retrieve.</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<T>> ExecuteQueryAsync<T>(this ICosmosDbSqlClient that, SqlQuerySpec sqlQuerySpec, string partitionKey, int pageSize, int pageIndex)
        {
        ...
        /// <param name="continuationToken">The previous request's continuation token (or null).</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<T>> ExecuteQueryAsync<T>(this ICosmosDbSqlClient that, string queryText, SqlParameterCollection parameters, string partitionKey, int maxItemCount, string continuationToken)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="continuationToken">The previous request's continuation token (or null).</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<T>> ExecuteQueryAsync<T>(this ICosmosDbSqlClient that, string queryText, string partitionKey, int maxItemCount, string continuationToken)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="continuationToken">The previous request's continuation token (or null).</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<T>> ExecuteQueryAsync<T>(this ICosmosDbSqlClient that, SqlQuerySpec sqlQuerySpec, string partitionKey, int maxItemCount, string continuationToken)
        {
        ...
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        /// <remarks>The result is a Cosmos DB <see cref="FeedResponse{T}"/> which can provide more details about the query response.</remarks>
        public static Task<FeedResponse<T>> ExecuteQueryAsync<T>(this ICosmosDbSqlClient that, SqlQuerySpec sqlQuerySpec, string partitionKey, FeedOptions feedOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="pageIndex">The page index to retrieve.</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<Document>> ExecuteQueryAsync(this ICosmosDbSqlClient that, string queryText, string partitionKey, int pageSize, int pageIndex)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="pageIndex">The page index to retrieve.</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<Document>> ExecuteQueryAsync(this ICosmosDbSqlClient that, string queryText, SqlParameterCollection parameters, string partitionKey, int pageSize, int pageIndex)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="feedOptions">The Cosmos DB feed options.</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<Document>> ExecuteQueryAsync(this ICosmosDbSqlClient that, string queryText, string partitionKey, int pagesToSkip = 0, FeedOptions feedOptions = null)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="feedOptions">The Cosmos DB feed options.</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<Document>> ExecuteQueryAsync(this ICosmosDbSqlClient that, string queryText, SqlParameterCollection parameters, string partitionKey, int pagesToSkip = 0, FeedOptions feedOptions = null)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="pageIndex">The page index to retrieve.</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<Document>> ExecuteQueryAsync(this ICosmosDbSqlClient that, SqlQuerySpec sqlQuerySpec, string partitionKey, int pageSize, int pageIndex)
        {
        ...
        /// <param name="continuationToken">The previous request's continuation token (or null).</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<Document>> ExecuteQueryAsync(this ICosmosDbSqlClient that, string queryText, SqlParameterCollection parameters, string partitionKey, int maxItemCount, string continuationToken)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="continuationToken">The previous request's continuation token (or null).</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<Document>> ExecuteQueryAsync(this ICosmosDbSqlClient that, string queryText, string partitionKey, int maxItemCount, string continuationToken)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <param name="continuationToken">The previous request's continuation token (or null).</param>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<FeedResponse<Document>> ExecuteQueryAsync(this ICosmosDbSqlClient that, SqlQuerySpec sqlQuerySpec, string partitionKey, int maxItemCount, string continuationToken)
        {
        ...
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        /// <remarks>The result is a Cosmos DB <see cref="FeedResponse{Document}"/> which can provide more details about the query response.</remarks>
        public static Task<FeedResponse<Document>> ExecuteQueryAsync(this ICosmosDbSqlClient that, SqlQuerySpec sqlQuerySpec, string partitionKey, FeedOptions feedOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <typeparam name="T">The type of the entity to retrieve.</typeparam>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<IEnumerable<EntityInstance<T>>> ExecuteQueryForEntityInstancesAsync<T>(this ICosmosDbSqlClient that, string queryText, string partitionKey, int pageSize, int pageIndex)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <typeparam name="T">The type of the entity to retrieve.</typeparam>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<IEnumerable<EntityInstance<T>>> ExecuteQueryForEntityInstancesAsync<T>(this ICosmosDbSqlClient that, string queryText, SqlParameterCollection parameters, string partitionKey, int pageSize, int pageIndex)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <typeparam name="T">The type of the entity to retrieve.</typeparam>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<IEnumerable<EntityInstance<T>>> ExecuteQueryForEntityInstancesAsync<T>(this ICosmosDbSqlClient that, string queryText, string partitionKey, int pagesToSkip = 0, FeedOptions feedOptions = null)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <typeparam name="T">The type of the entity to retrieve.</typeparam>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<IEnumerable<EntityInstance<T>>> ExecuteQueryForEntityInstancesAsync<T>(this ICosmosDbSqlClient that, string queryText, SqlParameterCollection parameters, string partitionKey, int pagesToSkip = 0, FeedOptions feedOptions = null)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <typeparam name="T">The type of the entity to retrieve.</typeparam>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<IEnumerable<EntityInstance<T>>> ExecuteQueryForEntityInstancesAsync<T>(this ICosmosDbSqlClient that, SqlQuerySpec sqlQuerySpec, string partitionKey, int pageSize, int pageIndex)
        {
        ...
        /// <typeparam name="T">The type of the entity to retrieve.</typeparam>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<IEnumerable<EntityInstance<T>>> ExecuteQueryForEntityInstancesAsync<T>(this ICosmosDbSqlClient that, string queryText, SqlParameterCollection parameters, string partitionKey, int maxItemCount, string continuationToken)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <typeparam name="T">The type of the entity to retrieve.</typeparam>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<IEnumerable<EntityInstance<T>>> ExecuteQueryForEntityInstancesAsync<T>(this ICosmosDbSqlClient that, string queryText, string partitionKey, int maxItemCount, string continuationToken)
        {
            if (queryText == null)
            {
                throw new ArgumentNullException(nameof(queryText));
        ...
        /// <typeparam name="T">The type of the entity to retrieve.</typeparam>
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        public static Task<IEnumerable<EntityInstance<T>>> ExecuteQueryForEntityInstancesAsync<T>(this ICosmosDbSqlClient that, SqlQuerySpec sqlQuerySpec, string partitionKey, int maxItemCount, string continuationToken)
        {
        ...
        /// <returns>The task for an enumerable of objects matching the query specification.</returns>
        /// <remarks>The result is a Cosmos DB <see cref="FeedResponse{T}"/> which can provide more details about the query response.</remarks>
        public static Task<IEnumerable<EntityInstance<T>>> ExecuteQueryForEntityInstancesAsync<T>(this ICosmosDbSqlClient that, SqlQuerySpec sqlQuerySpec, string partitionKey, FeedOptions feedOptions = null, CancellationToken cancellationToken = default)
        {
