...
namespace Corvus.Extensions.CosmosDb.Sql.Specs
{
    ...
    [NUnit.Framework.DescriptionAttribute("Delete an entity from a Cosmos DB collection")]
    [NUnit.Framework.CategoryAttribute("setupContainer")]
    [NUnit.Framework.CategoryAttribute("setupCosmosDBSqlClient")]
    public partial class DeleteAnEntityFromACosmosDBCollectionFeature
    {
        
        private TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "DeleteAnEntityFromACosmosDbCollection.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Delete an entity from a Cosmos DB collection", "\tIn order to persist POCO entities\r\n\tAs a developer\r\n\tI want to be able to delete" +
                    " an entity from a Cosmos DB collection", ProgrammingLanguage.CSharp, new string[] {
                        "setupContainer",
...
#line hidden
            ...
            table5.AddRow(new string[] {
                        ...
                        "3"});
#line 21
 testRunner.Given("I store the entities", ((string)(null)), table5, "Given ");
#line 24
