...
namespace Corvus.Repository.Specs
{
    ...
    [NUnit.Framework.DescriptionAttribute("Delete an entity from a repository")]
    [NUnit.Framework.CategoryAttribute("setupContainer")]
    [NUnit.Framework.CategoryAttribute("setupCosmosDBRepository")]
    public partial class DeleteAnEntityFromARepositoryFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Delete an entity from a repository", "\tIn order to persist POCO entities\r\n\tAs a developer\r\n\tI want to be able to delete" +
                    " an entity from a repository", ProgrammingLanguage.CSharp, new string[] {
                        "setupContainer",
