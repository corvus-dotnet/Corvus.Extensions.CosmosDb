...
namespace Corvus.Repository.Specs
{
    ...
    [NUnit.Framework.DescriptionAttribute("Query entities from a repository")]
    ...
    public partial class QueryEntitiesFromARepositoryFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Query entities from a repository", "\tIn order to persist POCO entities\r\n\tAs a developer\r\n\tI want to be able to query " +
                    "entities from a repository", ProgrammingLanguage.CSharp, new string[] {
                        "setupContainer",
