...
namespace Corvus.SpecFlow.Extensions.CosmosDb
{
    ...
    public static class CosmosDbBeforeFeatureOrder
    {
        ...
        /// The <c>Order</c> at which the client object is created..
        /// </summary>
        public const int PopulateDatabaseCollection = UnpopulatedDatabaseCollectionAvailable + 1;
        ...
        /// </summary>
        /// <remarks>
        /// This leaves a space of 99 after <see cref="PopulateDatabaseCollection"/> (so this is 20200) to
        ...
        /// </remarks>
        public const int DatabaseCollectionAvailable = PopulateDatabaseCollection + 99;
    }
}
