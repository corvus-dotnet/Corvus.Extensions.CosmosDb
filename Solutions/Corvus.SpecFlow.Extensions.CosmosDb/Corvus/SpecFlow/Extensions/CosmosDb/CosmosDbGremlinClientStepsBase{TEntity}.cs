...
namespace Corvus.SpecFlow.Extensions.CosmosDb
{
    ...
    public abstract class CosmosDbGremlinClientStepsBase<TEntity> : CosmosDbStepsBase<ICosmosDbGremlinClient, TEntity>
    {
        /// <summary>
        /// Create a <see cref="CosmosDbGremlinClientStepsBase{TEntity}"/>.
        /// </summary>
        ...
        protected CosmosDbGremlinClientStepsBase(
