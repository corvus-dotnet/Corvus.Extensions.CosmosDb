// <copyright file="CosmosDbSqlClientStepsBase{TEntity}.cs" company="Endjin Limited">
...
namespace Corvus.SpecFlow.Extensions.CosmosDb
{
    ...
    /// <summary>
    /// Base class for SpecFlow steps that use a SQL-based Cosmos DB store.
    /// </summary>
    /// <typeparam name="TEntity">The entity type returned by queries.</typeparam>
    public abstract class CosmosDbSqlClientStepsBase<TEntity> : CosmosDbStepsBase<ICosmosDbSqlClient, TEntity>
    {
        /// <summary>
        /// Create a <see cref="CosmosDbSqlClientStepsBase{TEntity}"/>.
        /// </summary>
        ...
        protected CosmosDbSqlClientStepsBase(
